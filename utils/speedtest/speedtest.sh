...
wget -O clash_config.yml https://raw.githubusercontent.com/flappyD/V2RayAggregator11/master/utils/speedtest/clash_config.yml
...
wget -O lite_config.json https://raw.githubusercontent.com/flappyD/V2RayAggregator11/master/utils/speedtest/lite_config.json
#初始化 Clash
chmod +x ./clash && ./clash &
#安装并配置 proxychains
